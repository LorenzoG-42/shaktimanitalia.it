...
if (!class_exists('Autoev_Main')) { 
    class Autoev_Main extends Autoev_Base
    {
...
function autoev() {
    return Autoev_Main::getInstance();
}
// Install
autoev(); 
