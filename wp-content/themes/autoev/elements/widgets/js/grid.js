(function ($) {
    ...
    $(document).on('click', '.pxl-load-more', function () {
        ...
        $.ajax({
            ...
            data: {
                action: 'autoev_load_more_post_grid',
                settings: loadmore
            }
        })
            .done(function (res) {
    ...
    $(document).on('click', '.pxl-grid-pagination .ajax a.page-numbers', function () {
        ...
        $.ajax({
            ...
            data: {
                action: 'autoev_get_pagination_html',
    ...
    $(document).on('click', '.btn-product-grid-loadmore', function () {
        ...
        $.ajax({
            ...
            data: {
                action: 'autoev_load_more_product_grid',
                settings: loadmore
            }
        })
            .done(function (res) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/pxl_grid_custom.default', widget_post_masonry_handler);
    });
})(jQuery);