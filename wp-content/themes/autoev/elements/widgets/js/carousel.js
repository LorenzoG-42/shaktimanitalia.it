( function( $ ) {
    ...
    $( window ).on( 'elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/pxl_image_zoom_carousel.default', pxl_swiper_handler );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/pxl_history.default', pxl_swiper_handler );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/pxl_image_grid.default', pxl_swiper_handler );
