...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_showcase',
        'title' => esc_html__('BR Showcase', 'autoev'),
            ...
            'sections' => array(
                        ...
                        array(
                            ...
                            'options' => [
                                ...
                                '3' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_showcase/layout3.jpg'
                                ],
                                '4' => [
                                    'label' => esc_html__('Layout 4', 'autoev' ),
                                    'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_showcase/layout4.jpg'
                                ],
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'lists',
                            'label' => esc_html__('List Box', 'autoev'),
