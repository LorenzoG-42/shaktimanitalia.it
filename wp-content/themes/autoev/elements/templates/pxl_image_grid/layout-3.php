...
<?php if (isset($settings['image_list']) && !empty($settings['image_list']) && count($settings['image_list'])) : ?>
    <div class="pxl-grid pxl-team-grid pxl-image-grid3" data-layout="fitRows">
        <div class="pxl-grid-inner <?php echo esc_attr($msclass) ?> row" data-gutter="15">
            <?php foreach ($settings['image_list'] as $key => $value) :
                ...
                $image_size = !empty($img_size) ? $img_size : '150x100';
         ...
         data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms ">
                    ...
                    <?php if (!empty($image['id'])) : ?>
                        ...
                        <?php endif; ?>    
                    <div class="pxl-wrap-content col-8">                   
                            <?php if (!empty($title)) : ?>
