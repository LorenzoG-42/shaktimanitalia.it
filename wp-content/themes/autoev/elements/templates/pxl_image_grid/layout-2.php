...
<?php if (isset($settings['image_list']) && !empty($settings['image_list']) && count($settings['image_list'])) : ?>
    <div class="pxl-grid pxl-team-grid pxl-image-grid2" data-layout="fitRows">
        <div class="pxl-grid-inner <?php echo esc_attr($msclass) ?> row" data-gutter="15">
            <?php foreach ($settings['image_list'] as $key => $value) :
                ...
                $image_size = !empty($img_size) ? $img_size : '306x306';
            ...
            ?>
                <div class="<?php echo esc_attr($item_class); ?>">
                    <div class="pxl-item--inner row <?php echo esc_attr($settings['pxl_animate']); ?>">
                        <div class="pxl-wrap-content col-7">
