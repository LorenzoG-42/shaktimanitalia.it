...
?>
<div id="<?php echo esc_attr($html_id) ?>" class="pxl-image-single pxl-image2<?php if(!empty($settings['img_effect'])) { echo esc_attr($settings['img_effect']); } ?> <?php echo esc_attr($settings['style'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" <?php if($settings['img_effect'] == 'pxl-image-tilt') : ?>data-maxtilt="<?php echo esc_attr($settings['max_tilt']); ?>" data-speedtilt="<?php echo esc_attr($settings['speed_tilt']); ?>" data-perspectivetilt="<?php echo esc_attr($settings['perspective_tilt']); ?>"<?php endif; ?>>
            ...
            <?php switch ($settings['image_type']) {
                ...
                default: ?>
                    <div class="pxl-item--image" data-parallax-value="<?php echo esc_attr($settings['parallax_value']); ?>">
                        ...
                        <div class="pxl-item pxl-item--label1 ">
                            <div class="pxl-inform">
                                <div class="pxl-heading">
                                <?php echo esc_attr($settings['heading_1']); ?>
                                </div>
                                <div class="pxl-label">
                                <?php echo esc_attr($settings['inform_label1']); ?>
                                </div>
                            </div>          
                        </div>

                        <div class="pxl-item pxl-item--label2 ">
                            <div class="pxl-inform">
                                <div class="pxl-heading">
                                <?php echo esc_attr($settings['heading_2']); ?>
                                </div>
                                <div class="pxl-label">
                                <?php echo esc_attr($settings['inform_label2']); ?>
                                </div>
                            </div>          
                        </div>

                        <div class="pxl-item pxl-item--label3 ">
                            <div class="pxl-inform">
                                <div class="pxl-heading">
                                <?php echo esc_attr($settings['heading_3']); ?>
                                </div>
                                <div class="pxl-label">
                                <?php echo esc_attr($settings['inform_label3']); ?>
                                </div>
                            </div>          
                        </div>

                        <div class="pxl-item pxl-item--label4 ">
                            <div class="pxl-inform">
                                <div class="pxl-heading">
                                <?php echo esc_attr($settings['heading_4']); ?>
                                </div>
                                <div class="pxl-label">
                                <?php echo esc_attr($settings['inform_label4']); ?>
                                </div>
                            </div>          
                        </div>
