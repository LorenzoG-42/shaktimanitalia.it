...
$settingl =  $widget->get_setting('settingl');
$load_more = array(
    'tax'             => $tax,
    'post_type'       => $post_type,   
    'layout'          => $layout,
