...
if($settings['col_xl'] == '5') {
    $col_xl = '20-pxl';
} elseif($settings['col_xl'] == 'col-40') {
    $col_xl = '40-pxl';
} else {
   $col_xl = 12 / intval($widget->get_setting('col_xl', 4));
}
if($settings['col_lg'] == '5') {
    $col_lg = '20-pxl';
} elseif($settings['col_lg'] == 'col-40') {
    $col_lg = '40-pxl';
} else {
...
$layout = $widget->get_setting('layout_'.$post_type, 'post-4');
...
$select =  $widget->get_setting('select');
$load_more = array(
    'num_words'       => $num_words,
    'tax'             => $tax,
    'post_type'       => $post_type,   
