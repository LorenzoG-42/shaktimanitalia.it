...
$col_xl = ($settings['col_xl'] == '5') ? 'pxl5' : 12 / intval($widget->get_setting('col_xl', 4));
...
$image_size_popup = $widget->get_setting('image_size_popup');
...
<div id="<?php echo esc_attr($html_id); ?>" class="pxl-grid pxl-portfolio-grid pxl-portfolio-grid-layout2 pxl-portfolio-style2" data-layout="masonry" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
    ...
    <div class="<?php echo esc_attr($grid_class); ?>" data-gutter="15">
        <?php autoev_get_portfolio_grid_layout2($posts, $load_more); ?>
