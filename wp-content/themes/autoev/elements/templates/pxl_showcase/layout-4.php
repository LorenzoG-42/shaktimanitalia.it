...
<div class="pxl-showcase pxl-showcase4">
    <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
        <div class="pxl-item--image">
            ...
            <div class="pxl-item--meta">
                <div class="pxl-item--title"><?php echo esc_html($settings['title']); ?></div>
            </div>
                    ...
                    ?>
                        <div class="pxl--item">
                            <div class="pxl-item-content">
                                <div class="pxl-desc">
                                    <span><i aria-hidden="true" class="fas fa-check"></i> </span>
                                    <span class="pxl-item-heading"><?php echo pxl_print_html($heading_icon); ?></span>
